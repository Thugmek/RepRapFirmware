...
class PrintMonitor
{
	public:
		...
		float FractionOfFilePrinted(bool useLayerZ = false) const;
...
inline bool PrintMonitor::IsPalette2Printing() const { return isPrinting && (strstr(GetPrintingFilename(), ".mcf") != nullptr); }
